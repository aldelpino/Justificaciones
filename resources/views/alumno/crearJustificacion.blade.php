                ...
                <div id="wizard" class="form_wizard wizard_horizontal">
                  ...
                  <div id="step-1">
                    <div class="form-horizontal form-label-left">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control" id="inputSuccess5"  placeholder="Telefono/Celular" name="celular_alum" value="{{$datosAlumno->CELULAR}}" maxlength="8">
                  ...
                  <div id="step-2" style="overflow:auto; height:480px">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="input-prepend input-group">
                        ...
                        {{-- <input type="text" style="width: 200px" name="fechaJustificacion" id="reservation" class="form-control" value="01/01/2018 - 25/01/2018" /> --}}
                        <input type="text" style="width: 200px" name="fechaJustificacion" id="fechaJustificacion" class="form-control" value="01/01/2018 - 25/01/2018" />
                      </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <select class="form-control" id="carritoJC" name="asignatura" placeholder="Seleccionar asignatura">
                        <option value='holi' disabled>Seleccionar asignatura</option>
                  ...
                  <div id="step-3">
                    ...
                    <div class="x_content">
                      ...
                      <div class="dropzone dropzone-previews" id="justificationFileDropzone"></div>
                      <br />
                      <br />
                      <br />
                      <br />
...
@section('utilities')
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
      $('#fechaJustificacion').daterangepicker({
      ...
      Dropzone.autoDiscover = false;
      $("#justificationFileDropzone").dropzone({
        url: "image/upload/store/",
        maxFiles: 3,
        maxFilesize: 2,
        dictDefaultMessage: "Dejar archivos aqui",
