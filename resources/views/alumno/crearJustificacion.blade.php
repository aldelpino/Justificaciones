                    ...
                    <div id="step-2" style="overflow:auto; height:480px">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <div class="checkbox form-group">
                          <label>
                            <input name="tipoInasistencia" type="checkbox" value="SI" class="validarStep"> SI
                          </label>
                        </div>
                        <div class="checkbox form-group">
                          <label>
                            <input name="tipoInasistencia" type="checkbox" value="NO" class="validarStep"> NO
                          </label>
                        </div>
                      </div>
                    </div>
        ...
        function validateSteps(stepnumber){
            ...
            if(stepnumber == 2){
                ...
                if( document.getElementById('seleccionoFecha').value === "" ) {
                    ...
                    isStepValid = false;
                } else if ( !document.querySelector('.validarStep').checked) {
                    document.getElementById("alertBox").style.opacity=1;
                    document.getElementById("alertBox").innerHTML="Debes indicar si faltaste a alguna evaluación...(Click para cerrar)";
